...
1. Fork your own copy of the repository to your GitHub account by clicking on
   `Fork` button on [crowdsentinel-mcp-server's GitHub repository](https://github.com/Medjed/crowdsentinel-mcp-server).
2. Clone the forked repository on your local setup.

    ```bash
    git clone https://github.com/$user/crowdsentinel-mcp-server
    ```

   Add a remote upstream to track upstream `crowdsentinel-mcp-server` repository.

    ```bash
    git remote add upstream https://github.com/Medjed/crowdsentinel-mcp-server
    ```
...
6. Create a Pull request on GitHub.
   Visit your fork at `https://github.com/$user/crowdsentinel-mcp-server` and click
